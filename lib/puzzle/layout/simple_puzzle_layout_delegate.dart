  ...
  Widget build(BuildContext context) {
    ...
    return TextButton(
      style: TextButton.styleFrom(
        primary: ThemeConstants.white,
        textStyle: ThemeConstants.headline2.copyWith(
        ...
        foregroundColor: MaterialStateProperty.all(ThemeConstants.white),
...
class SimplePuzzleShuffleButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PuzzleButton(
      textColor: ThemeConstants.primary0,
      backgroundColor: ThemeConstants.primary6,
